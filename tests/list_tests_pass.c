...
char *test_unshift()
{
    ...
    mu_assert(List_first(list) == test1, "Wrong first on unshift.");

    List_unshift(list, test2);
    mu_assert(List_first(list) == test2, "Wrong first on unshift.");

    List_unshift(list, test3);
    mu_assert(List_first(list) == test3, "Wrong first on unshift.");
...
char *test_shift()
{
    ...
    mu_assert(List_count(list) == 1, "Wrong count on shift.");

    val = List_shift(list);
    mu_assert(val == test1, "Wrong value on shift.");
    mu_assert(List_count(list) == 0, "Wrong count on shift.");
...
char *test_clear()
{
    char *test1 = strdup("data1");
    char *test2 = strdup("data2");
    char *test3 = strdup("data3");
